...
pub enum CalErrorKind{
    ...
    /// (Table 5.9-2).
    InvalidState { current: base::AsbConnectionState },
...
impl Display for CalErrorKind {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::InvalidServiceIdentifier => write!(f, "Invalid or unregistered service identifier"),
            Self::SerializationError       => write!(f, "CAL Message (de)serialization error"),
            Self::AbstractInstantiation    => write!(f, "Cannot instantiate abstract CAL Message type"),
